...
module chrome_sandbox_minimalblue 1.0;
...
" > chrome_sandbox_minimalblue.te

checkmodule -M -m -o chrome_sandbox_minimalblue.mod chrome_sandbox_minimalblue.te
semodule_package -o chrome_sandbox_minimalblue.pp -m chrome_sandbox_minimalblue.mod
semodule -i chrome_sandbox_minimalblue.pp

rm chrome_sandbox_minimalblue.te
rm chrome_sandbox_minimalblue.mod
rm chrome_sandbox_minimalblue.pp
